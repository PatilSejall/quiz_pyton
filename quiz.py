...
def loginPage(logdata):
    ...
    log.configure(width = 15,height=1, activebackground = "white", relief = FLAT)
...
def signUpPage():
    ...
    sp.configure(width = 15,height=1, activebackground = "white", relief = FLAT)
...
def start():
    ...
    button.configure(width = 102,height=2, activebackground = "white", relief = RAISED)
